...
const userNavItems = [
  ...
  { to: '/verify', icon: Search, label: 'Проверка' },
...
const adminNavItems = [
  ...
  { to: '/admin/verifications', icon: ShieldCheck, label: 'Верификации' },
  { to: '/admin/products', icon: Package, label: 'Продукты' },
  { to: '/admin/brands', icon: Tags, label: 'Бренды' },
  { to: '/admin/users', icon: Users, label: 'Пользователи' },
  { to: '/admin/images', icon: Images, label: 'Изображения' },
];
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
            ...
            <div>
              ...
              >
                {isAdminRoute ? 'Admin Workspace' : 'User Workspace'}
              </div>
            </div>
          </div>
        </div>
